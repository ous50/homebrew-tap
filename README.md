...
| --- | --- | --- | --- | --- |
| [`maaend-beta`](Casks/maaend-beta.rb) | `2.28.0-beta.4` | An Arknights:Endfield automation helper based on vision AI, in beta version. | macOS, Linux | [Homepage](https://github.com/MaaEnd/MaaEnd) |
